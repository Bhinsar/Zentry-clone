...
const BentoTilt = ({children, className=""}) => {
    ...
    const handleMouseMove = (e) => {
        ...
        setTransfromStyle(`perspective(1000px) rotateX(${rotateX}deg) rotateY(${rotateY}deg) scale(1.05)`);
    }
    ...
    return (
        <div ref={itemRef} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} className={`bento-tilt ${className}`} style={{transform: transfromStyle}}>
            {children}
        </div>
    )
}
      ...
      <div className="container mx-auto px-3 md:px-10">
        ...
        <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
          <BentoCard
            ...
            description="The game of games app transforming moments across web2 and web3 titles into rewards"
          />
        </BentoTilt>
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_2">
            <video src="videos/feature-5.mp4" autoPlay muted loop className=" size-full object-cover object-center" />
          </BentoTilt>
        </div>
      </div>
    </section>
